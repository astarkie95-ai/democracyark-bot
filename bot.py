...
class StarterKitPanelView(discord.ui.View):
    ...
    @discord.ui.button(label="🎖️ Claim Ark Starter Pack", style=discord.ButtonStyle.primary, custom_id="starterpanel_claim")
...
def _compute_taming(creature_key: str, level: int, settings: CalcSettings, food_pref: str, weapon_text: str, weapon_damage_pct: float):
    ...
    # Note: The wiki module's affinity values are 4x Dododex-style; normalize by /4 above.
